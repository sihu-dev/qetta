    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mb-8 text-4xl font-bold text-white">이용약관</h1>

          <div className="prose prose-invert max-w-none">
            <p className="text-zinc-400 mb-8">최종 수정일: 2025년 1월 1일</p>

            <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">제1조 (목적)</h2>
            ...
            <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">제2조 (용어의 정의)</h2>
            <p className="text-zinc-400 mb-4">
            ...
            <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">제3조 (약관의 효력 및 변경)</h2>
            <p className="text-zinc-400 mb-4">
            ...
            <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">제4조 (서비스 이용)</h2>
            <p className="text-zinc-400 mb-4">
            ...
            <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">제5조 (회원의 의무)</h2>
            <p className="text-zinc-400 mb-4">
            ...
            <div className="bg-white/[0.04] border border-white/[0.06] mt-12 rounded-lg p-4">
              <p className="text-zinc-400 text-sm">
                문의사항이 있으시면{' '}
                <a href="/contact" className="text-[#7C8AEA] hover:underline">
                  문의하기
                </a>{' '}
                페이지를 통해 연락해 주세요.
              </p>
